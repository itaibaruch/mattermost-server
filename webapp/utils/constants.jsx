...
export const Constants = {
    ...
    THEMES: {
        default: {
            ...
            sidebarBg: '#C9DD03',
            sidebarText: '#2C2D2F',
            sidebarUnreadText: '#2C2D2F',
            sidebarTextHoverBg: '#8DAA0B',
            sidebarTextActiveBorder: '#C9DD03',
            sidebarTextActiveColor: '#2C2D2F',
            sidebarHeaderBg: '#8DAA0B',
            sidebarHeaderTextColor: '#ffffff',
            onlineIndicator: '#B90000',
